...
export default function AdminLogin({ onClose }) {
  ...
  // Simple floating animation for background elements - Admin themed colors
  ...
  return (
    ...
    >
      {/* Background Shapes - Admin themed colors */}
      <FloatingShape 
        delay={0} 
        size="80px" 
      ...
      <FloatingShape 
        delay={0.2} 
        size="60px" 
        color="linear-gradient(45deg, #34495e, #2980b9)" 
      ...
      <FloatingShape 
        delay={0.6} 
        size="70px" 
        color="linear-gradient(45deg, #8e44ad, #9b59b6)" 
      ...
      >
        ...
        <button
          ...
          onMouseEnter={(e) => {
            e.target.style.background = 'rgba(44, 62, 80, 0.1)';
        ...
        >
          ...
          <div style={{ marginBottom: '20px' }}>
            <input
              ...
              onFocus={(e) => {
                e.target.style.borderColor = errors.email ? '#dc3545' : '#2c3e50';
                e.target.style.background = 'rgba(255, 255, 255, 1)';
              }}
              onBlur={(e) => {
                e.target.style.borderColor = errors.email ? '#dc3545' : 'rgba(44, 62, 80, 0.1)';
          ...
          <div style={{ marginBottom: '30px' }}>
            <input
              ...
              onFocus={(e) => {
                e.target.style.borderColor = errors.password ? '#dc3545' : '#2c3e50';
                e.target.style.background = 'rgba(255, 255, 255, 1)';
              }}
              onBlur={(e) => {
                e.target.style.borderColor = errors.password ? '#dc3545' : 'rgba(44, 62, 80, 0.1)';
                e.target.style.background = 'rgba(255, 255, 255, 0.8)';
              }}
            />
            {errors.password && (
        ...
        >
          <button 
            ...
            style={{
              ...
              cursor: 'pointer',
              transition: 'all 0.3s ease',
              boxShadow: '0 8px 25px rgba(52, 152, 219, 0.24)',
              marginBottom: '20px'
            }}
            onMouseEnter={(e) => {
              e.target.style.transform = 'translateY(-2px)';
              e.target.style.boxShadow = '0 12px 30px rgba(44, 62, 80, 0.4)';
            }}
            onMouseLeave={(e) => {
      ...
      <style jsx>{`
        ...
        .admin-login-modal::-webkit-scrollbar {
          width: 6px;
        }

        .admin-login-modal::-webkit-scrollbar-track {
          background: rgba(44, 62, 80, 0.1);
          border-radius: 10px;
        }

        .admin-login-modal::-webkit-scrollbar-thumb {
          background: linear-gradient(135deg, #2c3e50, #3498db);
          border-radius: 10px;
        }
      `}</style>
